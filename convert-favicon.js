...
async function convertToIco() {
  try {
    ...
    await sharp(inputFile).resize(16, 16).png().toFile('public/favicon-16x16.png');

    // Criar favicon de 32x32
    await sharp(inputFile).resize(32, 32).png().toFile('public/favicon-32x32.png');

    // Criar favicon de 48x48 para qualidade melhor
    await sharp(inputFile).resize(48, 48).png().toFile('public/favicon-48x48.png');

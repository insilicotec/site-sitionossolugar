...
const Footer = () => {
  ...
  return (
    <footer className="text-white pt-16 pb-8 bg-black bg-[nature-earth-600]">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            >
              <h2 className="font-display text-2xl font-bold mb-4 text-zinc-50">
                Sítio Nosso Lugar
              </h2>
              <p className="text-gray-400 mb-6">
                Seu refúgio natural para momentos especiais. Um espaço cercado pela natureza e
                projetado para suas melhores celebrações.
              </p>
          ...
          >
            ...
            >
              ...
              <div className="relative bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 hover:from-amber-300 hover:via-amber-400 hover:to-amber-500 text-white px-3 py-2 md:px-5 md:py-2.5 rounded-lg transition-all duration-300 flex items-center gap-2 md:gap-2.5 shadow-md animate-sheen">
                ...
                <span className="font-semibold text-sm md:text-base drop-shadow tracking-wide">
                  Quero fazer um site
                </span>
              </div>
            </motion.a>
...
const SocialLink = ({ href, icon }: { href: string; icon: React.ReactNode }) => (
  <motion.a
    ...
    target="_blank"
    rel="noopener noreferrer"
    className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-amber-700 hover:text-white transition-colors"
    whileHover={{
      y: -3,
    }}
  >

      ...
      <div className="container px-4 md:px-6 mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16 lg:mb-20" ref={ref}>
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-light px-2">
            Um santuário natural cuidadosamente preservado, criado para proporcionar experiências
            inesquecíveis em harmonia com a natureza.
          </p>
        </div>{' '}
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed text-lg">
                      O Sítio Nosso Lugar nasceu do sonho de criar um refúgio onde as pessoas
                      pudessem se reconectar com a natureza enquanto celebram momentos especiais.
                      Com mais de 10 anos de experiência, construímos uma reputação sólida
                      oferecendo momentos únicos em meio à natureza.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-amber-100/50 p-8 rounded-2xl border border-amber-200/50">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed text-lg">
                      Preservamos a vegetação nativa e integramos nossa estrutura à paisagem
                      natural, criando ambientes que respeitam e valorizam o meio ambiente.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 p-8 rounded-2xl border border-blue-200/50">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed text-lg">
                      Cada detalhe do nosso espaço foi pensado para proporcionar conforto e uma
                      experiência autêntica, onde seus convidados se sentirão acolhidos pela beleza
                      da natureza.
                    </p>
                  </div>{' '}
                </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 leading-relaxed text-sm">
                          O Sítio Nosso Lugar nasceu do sonho de criar um refúgio onde as pessoas
                          pudessem se reconectar com a natureza enquanto celebram momentos
                          especiais. Com mais de 10 anos de experiência, construímos uma reputação
                          sólida oferecendo momentos únicos em meio à natureza.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 p-6 rounded-2xl border border-blue-200/50 w-80 flex-shrink-0">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 leading-relaxed text-sm">
                          Cada detalhe do nosso espaço foi pensado para proporcionar conforto e uma
                          experiência autêntica, onde seus convidados se sentirão acolhidos pela
                          beleza da natureza.
                        </p>
                      </div>
                    </div>

        ...
        <section className="py-12 sm:py-16 md:py-24 relative overflow-hidden">
          ...
          <div className="container px-2 sm:px-4 mx-auto relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-amber-900 mb-4 sm:mb-6 px-2">
              ...
              <p className="text-base sm:text-lg text-gray-700 px-2">
                ...
                a diferentes tipos de parcerias que tragam valor para nossos visitantes e seu
                negócio.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-4 sm:p-6 max-w-2xl mx-auto">
              ...
              <p className="text-gray-600 mb-3 sm:mb-4 text-sm sm:text-base">
                Todas as parcerias são avaliadas individualmente para garantir alinhamento com
                nossos valores de sustentabilidade, respeito à natureza e experiências autênticas.
              </p>
              <p className="text-gray-600 mb-3 sm:mb-4 text-sm sm:text-base">
